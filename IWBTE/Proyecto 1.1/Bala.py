...
class Bala(pygame.sprite.Sprite):
    def __init__(self, vichopls,dir):
        ...
        self.frameActual = 1
        self.recorrido = 0
        self.image = load_image("Baqueta/Frames/1.gif", "imagenes", alpha=True)
    ...
    def cambiarFrame(self):
        if self.mov == True:
            ...
            if self.frameActual>8:
                self.frameActual = 1
            self.image = load_image("Baqueta/Frames/"+str(self.frameActual)+".gif", "imagenes", alpha=True)
